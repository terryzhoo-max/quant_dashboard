...
===================================
五维择时信号系统:
  D1: ERP绝对值 (1/PE - 10Y国债)       — 权重25%  [估值]
  D2: ERP历史分位 (近5年)               — 权重25%  [估值]
  D3: M1同比趋势 (拐点+方向)            — 权重30%  [流动性]
  D4: 波动率指标 (PE滚动标准差)          — 权重10%  [风险] NEW
  D5: 信用环境 (M1-M2剪刀差)            — 权重10%  [风险] NEW
...
class ERPTimingEngine:
    ...
    # 五维权重
    W = {"erp_abs": 0.25, "erp_pct": 0.25, "m1_trend": 0.30, "volatility": 0.10, "credit": 0.10}

...
# V5 五档阈值 (基于 AIAE_简 直接值)
V5_REGIME_THRESHOLDS = [22.8, 24.0, 26.5, 28.3]
#   R1: <22.8% (P10, 极度低估, 2018贸战底/2024-01极低估)
#   R2: 22.8-24.0% (P10-P30, 低估, 2015-08股灾底)
#   R3: 24.0-26.5% (P30-P70, 中性, 2024-09正常)
#   R4: 26.5-28.3% (P70-P90, 高估, 2020-07/2026-04)
#   R5: >28.3% (P90, 极度高估, 2015-04杠杆牛/2021-02抱团)
...
# V5 缓冲带 (与V3一致)
V5_REGIME_SMOOTH_BUFFER = 0.5  # 比V3的1.5更窄，因为V5阈值间距更小(min=1.2pt)
